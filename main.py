...
pi_parent_dir = str(Path.home()) + "/e-Paper/RaspberryPi_JetsonNano/python"
...
if is_pi:
    ...
    font14 = ImageFont.truetype(fontfile, 14)
else:
...
def get_mem():
    if is_pi:
        ...
        Mem:          427072      136036      221120         976      121452      291036
...
def get_wifi_strength():
    if is_pi:
        ...
        wifistr = """
        wlan0     IEEE 802.11  ESSID:"SampleWiFi"
                Mode:Managed  Frequency:2.437 GHz  Access Point: 20:5C:4C:1B:40:80
...
udev               74616       0     74616   0% /dev
tmpfs              42708     968     41740   3% /run
/dev/mmcblk0p2  30097288 2485656  26063332   9% /
tmpfs             213536       0    213536   0% /dev/shm
tmpfs               5120       8      5112   1% /run/lock
/dev/mmcblk0p1    522230   63588    458642  13% /boot/firmware
tmpfs              42704       0     42704   0% /run/user/1000
"""
    lines = diskstr.split("\n")
